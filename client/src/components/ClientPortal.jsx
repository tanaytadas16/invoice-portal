...
const InvoiceDecisionPortal = () => {
    const [invoices, setInvoices] = useState([]);

    // Function to fetch invoices from the server
    const fetchInvoices = async () => {
        try {
            const response = await axios.get("/api/invoices"); // Replace with your backend API endpoint to fetch invoices
...
export default InvoiceDecisionPortal;
